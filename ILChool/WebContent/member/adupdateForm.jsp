                        ...
                        <div class="card rounded-0 shadow">
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <button type="reset"  style="background: rgb(68, 93, 119)" class="btn btn-primary" align="center">회원탈퇴 처리</button>
                                </form>
                            </div>
                        </div>
                    </div>
